% Time-stamp: <Saturday 15 April 2023, Romain Lafarguette>
...
\begin{frame}
  \frametitle{Monetary Frameworks and Trilemma}
    \makebox[\linewidth]{\includegraphics[height=0.8\paperheight]{img/Trilemma.png}}  
\end{frame}
...
\frametitle{Central Bank Balance Sheet}
    \makebox[\linewidth]{\includegraphics[width=0.75\paperwidth]{img/central_bank_balance_sheet.png}}
\end{frame}
...
\frametitle{Central Bank Balance Sheet With Rates and Risk}
    \makebox[\linewidth]{\includegraphics[width=0.75\paperwidth]{img/central_bank_balance_sheet_rates.png}}
\end{frame}


\begin{frame}
\frametitle{PBoC FX Sterilization Costs}
    \makebox[\linewidth]{\includegraphics[width=0.75\paperwidth]{img/fx_sterilization_cost_china.PNG}}
\end{frame}


\begin{frame}
\frametitle{PBoC Foreign Reserves}
    \makebox[\linewidth]{\includegraphics[width=0.75\paperwidth]{img/pboc_fx_reserves.PNG}}
\end{frame}


\begin{frame}
\frametitle{Franc Suisse against Euro (Down Means CHF Appreciation)}
    \makebox[\linewidth]{\includegraphics[width=0.75\paperwidth]{img/chfeur.jpg}}
\end{frame}


\begin{frame}
\frametitle{Swiss National Bank Balance Sheet}
    \makebox[\linewidth]{\includegraphics[width=0.75\paperwidth]{img/snb_balance_sheet.png}}
\end{frame}

\begin{frame}
\frametitle{Swiss National Bank Losses}
    \makebox[\linewidth]{\includegraphics[width=0.75\paperwidth]{img/snb_losses.png}}
\end{frame}
...
\begin{frame}
  \frametitle{BSP FXI Implementation}
  \begin{wideitemize}
